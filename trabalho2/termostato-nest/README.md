...
![Nest Learning Thermostat instalado, exibindo a temperatura no display circular](assets/nest-parede.jpg)
...
![Display do Nest exibindo um relatório de consumo de energia](assets/nest-frente.jpg)
...
| Componente | 1ª geração (2011) | 2ª geração (2012) | 3ª geração (2015) | 4ª geração (2024) |
| --- | --- | --- | --- | --- |
| **Processador de aplicação** | TI Sitara **AM3703** (ARM Cortex-A8, OMAP3) | SoC ARM + 512 Mb DRAM Samsung | NXP i.MX6 (**ARM Cortex-A9 1 GHz + Cortex-M4 227 MHz**) | SoC ARM (não divulgado pelo Google) |
| **MCU auxiliar** | TI **MSP430F5526** (RISC 16-bit) | - (integrado) | Cortex-M4 do i.MX6 | - (integrado ao SoC) |
| **Rádio 802.15.4 (ZigBee/Thread)** | TI **CC2530** | Ember **EM357** (Cortex-M3) + FEM Skyworks 2436L | EM3xx | Thread nativo (**Matter** certificado, jun/2024) |
| **Wi-Fi** | TI **WL1270B** (802.11 b/g/n) | TI **WL1270B** (802.11 b/g/n) | Cypress **CYW43340** (módulo Murata, b/g/n **dual-band 2,4/5 GHz**) | 802.11n **dual-band 2,4/5 GHz** |
| **Memória** | flash + DRAM | NAND Micron **MT29F2G16** (2 Gb) + DRAM 512 Mb | - | não divulgado |
| **Gestão de energia** | TI **TPS65921B** | TI **TPS65921B** | PMIC dedicado | PMIC dedicado (não divulgado) |
| **Display** | TFT 2,5" (Tianma) | TFT (Tianma) | TFT 2,08" **480×480** (Tianma TM030XDHG30) | LCD circular 2,68" **600×600** px |
| **Sensor de presença** | PIR *near*+*far-field* | PIR *near*+*far-field* | PIR *near*+*far-field* | **Soli** (radar 60 GHz, *Motion Sense*) |
| **Bateria** | Li-ion recarregável | Li-ion recarregável | Li-ion **3,7 V / 2,1 Wh (568 mAh)** | Li-ion recarregável built-in (capacidade não divulgada) |
...
- **Link (DOI):** https://doi.org/10.1016/j.jss.2016.04.063
- **Link (PDF aberto - Academia.edu):** https://www.academia.edu/111977844/Open_source_FreeRTOS_as_a_case_study_in_real_time_operating_system_evolution
...
- **Link (DOI):** https://doi.org/10.1016/j.enbuild.2021.110834
- **Acesso:** Portal de Periódicos Capes / ScienceDirect (acesso institucional)
...
- **Link (DOI):** https://doi.org/10.1016/j.enbuild.2021.111808
- **Acesso:** Portal de Periódicos Capes / ScienceDirect (acesso institucional)
...
- **Link (DOI):** https://doi.org/10.1016/j.jobe.2022.105067
- **Acesso:** Portal de Periódicos Capes / ScienceDirect (acesso institucional)
...
| Produto | Fabricante | Ano (1ª versão da linha) | Sensores | Conectividade | Aprendizado / automação de presença | Voz / ecossistema | Preço aprox. (lançamento / atual) |
| --- | --- | --- | --- | --- | --- | --- | --- |
| **Nest Learning Thermostat** (estudado) | Nest / Google | 2011 | Temp, umidade, presença (PIR *near*+*far*), luz ambiente | Wi-Fi 2,4 GHz; IEEE 802.15.4 (ZigBee/Thread); BLE (gerações recentes) | **Sim**: aprende a agenda + *Auto-Away* (PIR) | Google Assistant / Alexa (hub externo) | USD 249 (1–3ª gen) / **USD 280** (4ª gen) |
| ecobee SmartThermostat (com voz) | ecobee | 2019 | Temp, umidade; **sensor remoto** (ocupação + temp) | Wi-Fi dual-band; Bluetooth 5.0; sensor remoto 915 MHz | Parcial: *Smart Home/Away* e *Follow Me* | **Alexa embutida**; Siri / Google / HomeKit | USD 249 (lançamento) / **USD 200–260** |
| Honeywell Home T9 | Honeywell / Resideo | 2019 | Temp, umidade; **sensor remoto** (ocupação, até 20 un.) | Wi-Fi dual-band; RedLINK 900 MHz (sensores) | *Adaptive Recovery* (limitado) | Alexa / Google | USD ~200 (lançamento) / **USD ~210** |
| Emerson Sensi Touch (ST75) | Emerson / Copeland | 2017 | Temp, umidade (sem sensor de ocupação nesta versão) | Wi-Fi 2,4 GHz (exige *C-wire*) | Não aprende; agenda + *geofencing* | Alexa / Google / HomeKit / SmartThings | USD 199,99 (lançamento) / **USD ~100–130** |
| tado° Smart Thermostat | tado° | 2014 | Temp, umidade, luz ambiente (sem PIR) | Wi-Fi via *Internet Bridge*; 868 MHz, 6LoWPAN mesh | *Geofencing* (presença via smartphone) | Alexa / Google / HomeKit | ~USD 160 (lançamento) / **~USD 145–220** |
| Amazon Smart Thermostat | Amazon (tecnologia Honeywell/Resideo) | 2021 | Temp, umidade (sem sensor remoto próprio) | Wi-Fi 2,4 GHz | *Alexa Hunches* (infere ocupação pela conta) | Alexa | USD 59,99 (lançamento) / **USD 80** |
...
O **Nest Learning Thermostat** representa um dos exemplos mais emblemáticos de sistemas embarcados de consumo: reúne hardware de baixa potência (arquitetura de dois processadores ARM: um para aplicação Linux e outro de tempo real para acionamento do HVAC), sensores simples (temperatura, umidade, PIR, luminosidade), conectividade heterogênea (Wi-Fi + IEEE 802.15.4) e software sofisticado (aprendizado de agenda, detecção de presença, RTOS) em um produto de fácil instalação e impacto mensurável no consumo energético residencial. A evolução ao longo das quatro gerações ilustra tendências centrais da área: integração crescente em SoCs, adoção de padrões abertos de interoperabilidade (Thread/Matter) e substituição de sensores passivos por tecnologia de radar (Soli na 4ª geração), reduzindo a dependência de componentes discretos.

A proposta de reprodução com **ESP32** demonstra que as funcionalidades essenciais do Nest (sensoriamento de temperatura, controle por histerese, interface giratória, detecção de presença e conectividade Wi-Fi/MQTT) são totalmente viáveis com os componentes disponíveis no kit da disciplina. As principais limitações estão na ausência de um sensor de umidade na lista de materiais, na impossibilidade de replicar o algoritmo de aprendizado de máquina com os recursos do microcontrolador e na interface de usuário restrita ao display OLED em comparação ao *dial* circular do Nest. Ainda assim, o protótipo cobre o núcleo funcional do termostato inteligente de forma adequada ao escopo acadêmico.

Do ponto de vista de sistemas embarcados, o trabalho reforça a importância de decisões de projeto como a arquitetura de dois processadores, o gerenciamento de energia por *power stealing*, a escolha de protocolos de comunicação de baixo consumo e o papel central dos algoritmos de previsão de ocupação na eficiência energética de sistemas HVAC. Esses elementos, amplamente documentados na literatura científica levantada, servem de base para o desenvolvimento de soluções embarcadas robustas e de impacto real no consumo energético residencial.
